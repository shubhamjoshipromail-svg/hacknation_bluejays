...
const specCore = {purchaseMode:"CASH_PAY" as const,vehicle:{vin:"1HGCM82633A004352",vinVerification:"CHECKSUM_ONLY" as const,year:2022,make:"Honda",model:"CR-V",trim:"EX",adasFeatures:["FRONT_CAMERA" as const]},damage:{service:"WINDSHIELD_REPLACEMENT" as const,drivable:true},requirements:{glassPreference:"AFTERMARKET_EQUIVALENT_ACCEPTABLE" as const,calibrationRequired:"YES" as const,serviceMode:["MOBILE" as const,"IN_SHOP" as const],warrantyRequired:true},serviceArea:{postalCode:"10001",exactAddressDisclosure:"AFTER_SELECTION" as const},schedule:{windows:["weekday morning","weekday afternoon"],flexible:true},authorization:{mayGatherQuotes:true as const,mayUseVerifiedCompetitorOffer:true,mayBook:false as const,maximumTotalMinor:null},unknowns:[]};
const specHash=freezeSpecCore(specCore);
const CALL_BRIEF="2022 Honda CR-V EX, VIN 1HGCM82633A004352. Windshield replacement for a drivable vehicle. Aftermarket equivalent glass is acceptable. Front-camera ADAS calibration is required. Mobile or in-shop service is acceptable in ZIP 10001. The schedule is flexible on weekday mornings or afternoons. Warranty is required.";
